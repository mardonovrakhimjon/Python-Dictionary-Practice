randomuser_data = {
    "results": [
        {
            "gender": "male",
            "name": {"title": "Mr", "first": "Atilla", "last": "Bennink"},
            "location": {
                "street": {"number": 7541, "name": "Hoveniersdreef"},
                "city": "Aalsmeerderbrug",
                "state": "Flevoland",
                "country": "Netherlands",
                "postcode": "3436 TI",
                "coordinates": {"latitude": "36.7507", "longitude": "-169.1103"},
            ...
            "dob": {"date": "1981-10-20T18:46:45.926Z", "age": 43},
            "registered": {"date": "2018-07-22T19:29:37.066Z", "age": 6},
            "phone": "(089) 8673781",
            "cell": "(06) 07494249",
            "id": {"name": "BSN", "value": "15051860"},
            "picture": {
        ...
        {
            "gender": "male",
            "name": {"title": "Mr", "first": "Stefanus", "last": "Hilgersom"},
            "location": {
                "street": {"number": 7440, "name": "Heerseweg"},
                "city": "Vianent",
                "state": "Drenthe",
                "country": "Netherlands",
                "postcode": "6192 YY",
                "coordinates": {"latitude": "-55.3806", "longitude": "-137.7538"},
                "timezone": {
                    "offset": "+9:00",
            ...
            "dob": {"date": "1952-11-13T22:24:35.073Z", "age": 72},
            "registered": {"date": "2007-05-03T21:00:13.638Z", "age": 18},
            "phone": "(0666) 479565",
            "cell": "(06) 61122281",
            "id": {"name": "BSN", "value": "61095465"},
            "picture": {
        ...
        {
            "gender": "female",
            "name": {"title": "Mrs", "first": "Suhasini", "last": "Bhardwaj"},
            "location": {
                "street": {"number": 6256, "name": "Rajpur Rd"},
                "city": "Hindupur",
                "state": "Chandigarh",
                "country": "India",
                "postcode": 15836,
                "coordinates": {"latitude": "38.0154", "longitude": "-138.0493"},
                "timezone": {
                    "offset": "+11:00",
            ...
            "dob": {"date": "1964-07-16T16:51:56.269Z", "age": 60},
            "registered": {"date": "2022-05-01T16:06:39.089Z", "age": 3},
            "phone": "8026632497",
            "cell": "8033452958",
            "id": {"name": "UIDAI", "value": "665013006039"},
            "picture": {
        ...
        {
            "gender": "female",
            "name": {"title": "Mrs", "first": "Javeria", "last": "Mathew"},
            "location": {
                "street": {"number": 2762, "name": "Ranganathan St"},
                "city": "Rampur",
                "state": "Lakshadweep",
                "country": "India",
                "postcode": 98452,
                "coordinates": {"latitude": "3.1370", "longitude": "67.1149"},
                "timezone": {
                    "offset": "+5:30",
            ...
            "dob": {"date": "1950-08-17T13:23:00.094Z", "age": 74},
            "registered": {"date": "2008-12-01T19:02:43.132Z", "age": 16},
            "phone": "7907297187",
            "cell": "7150550748",
            "id": {"name": "UIDAI", "value": "563040799740"},
            "picture": {
        ...
        {
            "gender": "female",
            "name": {"title": "Ms", "first": "Alison", "last": "Berry"},
            "location": {
                "street": {"number": 2348, "name": "Denny Street"},
                "city": "Ennis",
                "state": "Monaghan",
                "country": "Ireland",
                "postcode": 28185,
                "coordinates": {"latitude": "11.3828", "longitude": "50.7218"},
            ...
            "dob": {"date": "1971-01-15T20:06:35.808Z", "age": 54},
            "registered": {"date": "2014-07-08T03:11:53.424Z", "age": 10},
            "phone": "051-361-0762",
            "cell": "081-247-5252",
            "id": {"name": "PPS", "value": "8802998T"},
            "picture": {
        ...
        {
            "gender": "male",
            "name": {"title": "Mr", "first": "Kasper", "last": "Jensen"},
            "location": {
                "street": {"number": 7172, "name": "Svalevej"},
                "city": "Odense Sv",
                "state": "Nordjylland",
                "country": "Denmark",
                "postcode": 95030,
                "coordinates": {"latitude": "-5.5709", "longitude": "177.3968"},
                "timezone": {
                    "offset": "+3:00",
            ...
            "dob": {"date": "1984-07-29T04:14:21.525Z", "age": 40},
            "registered": {"date": "2011-04-01T19:57:48.123Z", "age": 14},
            "phone": "04442769",
            "cell": "87302398",
            "id": {"name": "CPR", "value": "280784-3032"},
            "picture": {
        ...
        {
            "gender": "male",
            "name": {"title": "Mr", "first": "Gregory", "last": "Reid"},
            "location": {
                "street": {"number": 3696, "name": "North Street"},
                "city": "Clane",
                "state": "Sligo",
                "country": "Ireland",
                "postcode": 79714,
                "coordinates": {"latitude": "50.7485", "longitude": "11.2381"},
                "timezone": {
                    "offset": "+5:30",
                    "description": "Bombay, Calcutta, Madras, New Delhi",
                },
            ...
            "dob": {"date": "1981-03-17T01:22:33.017Z", "age": 44},
            "registered": {"date": "2011-09-01T22:50:48.388Z", "age": 13},
            "phone": "031-809-7386",
            "cell": "081-391-0293",
            "id": {"name": "PPS", "value": "7652131T"},
            "picture": {
        ...
        {
            "gender": "male",
            "name": {"title": "Mr", "first": "Doeke", "last": "Krikke"},
            "location": {
                "street": {"number": 3265, "name": "Jasker"},
                "city": "De Heen",
                "state": "Zeeland",
                "country": "Netherlands",
                "postcode": "0246 PD",
                "coordinates": {"latitude": "16.8428", "longitude": "-178.4769"},
                "timezone": {
                    "offset": "+3:00",
                    "description": "Baghdad, Riyadh, Moscow, St. Petersburg",
                },
            ...
            "dob": {"date": "1973-10-04T21:57:52.699Z", "age": 51},
            "registered": {"date": "2004-06-29T10:11:07.931Z", "age": 20},
            "phone": "(073) 8548509",
            "cell": "(06) 56391513",
            "id": {"name": "BSN", "value": "91893015"},
            "picture": {
        ...
        {
            "gender": "female",
            "name": {"title": "Mrs", "first": "Molly", "last": "King"},
            "location": {
                "street": {"number": 7723, "name": "Pakowhai Road"},
                "city": "Porirua",
                "state": "West Coast",
                "country": "New Zealand",
                "postcode": 88562,
                "coordinates": {"latitude": "57.5969", "longitude": "-103.6105"},
                "timezone": {
                    "offset": "-4:00",
            ...
            "dob": {"date": "1944-09-26T11:01:55.071Z", "age": 80},
            "registered": {"date": "2020-03-15T15:52:54.648Z", "age": 5},
            "phone": "(752)-185-1017",
            "cell": "(248)-183-1465",
            "id": {"name": "", "value": None},
            "picture": {
        ...
        {
            "gender": "male",
            "name": {"title": "Mr", "first": "Spasoje", "last": "Šotra"},
            "location": {
                "street": {"number": 2739, "name": "Ljubomira Zekavice"},
                "city": "Bač",
                "state": "Jablanica",
                "country": "Serbia",
                "postcode": 75022,
                "coordinates": {"latitude": "-36.9400", "longitude": "-11.9675"},
            ...
            "dob": {"date": "1957-06-12T21:43:26.667Z", "age": 68},
            "registered": {"date": "2003-04-28T02:44:33.239Z", "age": 22},
            "phone": "016-5659-460",
            "cell": "067-3525-015",
            "id": {"name": "SID", "value": "357199251"},
            "picture": {
    ...
    "info": {"seed": "1e55a6ad8357689d", "results": 10, "page": 1, "version": "1.4"},
}
